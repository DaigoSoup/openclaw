...
export const KNIP_UNUSED_EXPORT_BASELINE = [
  ...
  "src/skills/workshop/experience-review.ts: buildSkillExperienceReviewPrompt",
  "src/skills/workshop/experience-review.ts: createSkillExperienceReviewScheduler",
  "src/skills/workshop/experience-review.ts: ExperienceReviewCandidate",
  "src/skills/workshop/experience-review.ts: formatSkillExperienceReviewTranscript",
  "src/skills/workshop/experience-review.ts: prepareSkillExperienceReviewCandidate",
  "src/skills/workshop/experience-review.ts: runSkillExperienceReview",
  "src/skills/workshop/experience-review.ts: SkillExperienceReviewParams",
