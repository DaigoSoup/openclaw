...
export const KNIP_UNUSED_EXPORT_BASELINE = [
  ...
  "extensions/telegram/src/telegram-reply-fence.ts: resetTelegramReplyFenceForTests",
  "extensions/telegram/src/thread-bindings.ts: setTelegramThreadBindingStoreForTest",
  "extensions/telegram/src/topic-name-cache-state.ts: TelegramTopicNamePersistentStore",
  ...
  "src/pairing/setup-code.ts: PairingSetupAccess",
  ...
  "src/shared/device-bootstrap-profile.ts: isPairingSetupBootstrapProfile",
