...
export const pt_BR: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccess: "Acesso total (recomendado)",
      fullAccessHint:
        "Node mais controles completos do Gateway, incluindo configurações e atualizações.",
      limitedAccess: "Acesso limitado",
      limitedAccessHint: "Node, chat e aprovações sem controles administrativos.",
      generateCode: "Criar código de configuração",
      transportLimitedTitle: "Limitado por segurança de rede",
      transportLimitedHint:
        "Esta URL do Gateway usa ws:// em texto simples. Use wss:// ou Tailscale Serve e depois crie um novo código para acesso total.",
