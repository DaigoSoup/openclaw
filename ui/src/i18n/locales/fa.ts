...
export const fa: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccessHint: "نود به‌همراه کنترل‌های کامل Gateway، شامل تنظیمات و به‌روزرسانی‌ها.",
      limitedAccess: "دسترسی محدود",
      limitedAccessHint: "نود، گفتگو و تأییدها بدون کنترل‌های مدیریتی.",
      generateCode: "ایجاد کد راه‌اندازی",
      transportLimitedTitle: "محدودشده برای امنیت شبکه",
      transportLimitedHint:
        "این آدرس Gateway از ws:// بدون رمزنگاری استفاده می‌کند. از wss:// یا Tailscale Serve استفاده کنید، سپس یک کد جدید برای دسترسی کامل ایجاد کنید.",
