...
export const ko: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccessHint: "노드와 설정 및 업그레이드를 포함한 완전한 Gateway 제어 기능을 제공합니다.",
      ...
      transportLimitedHint:
        "이 Gateway URL은 일반 텍스트 ws://를 사용합니다. wss:// 또는 Tailscale Serve를 사용한 후 전체 액세스를 위한 새 코드를 생성하세요.",
  ...
  quickSettings: {
    ...
    pending: {
      title: "저장되지 않은 변경 사항",
      hint: "저장하면 변경 사항이 저장됩니다. 지금 적용하면 현재 세션도 다시 로드됩니다.",
      discard: "취소",
      applying: "적용 중…",
      applyNow: "지금 적용",
    },
  ...
  configView: {
    ...
    unsavedChange: "저장되지 않은 변경 {count}개",
    unsavedChanges: "저장되지 않은 변경 {count}개",
    noChanges: "변경 사항 없음",
    rawDisabled: "Raw 모드가 비활성화되었습니다(스냅샷이 원시 텍스트를 안전하게 왕복할 수 없음).",
    open: "열기",
    clear: "지우기",
    apply: "적용",
    applying: "적용 중…",
    ...
    viewPendingChange: "대기 중인 변경 {count}개 보기",
    viewPendingChanges: "대기 중인 변경 {count}개 보기",
