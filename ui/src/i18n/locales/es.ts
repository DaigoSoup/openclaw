...
export const es: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccessHint:
        "Nodo más controles completos del Gateway, incluidos ajustes y actualizaciones.",
      ...
      transportLimitedTitle: "Limitado por seguridad de red",
      transportLimitedHint:
        "Esta URL del Gateway usa ws:// en texto sin cifrar. Usa wss:// o Tailscale Serve y luego crea un nuevo código para acceso completo.",
    ...
    inventory: {
      title: "Dispositivos",
      subtitle: "Una fila por cliente emparejado: estado, roles, tokens.",
  ...
  quickSettings: {
    ...
    pending: {
      ...
      hint: "Guardar almacena tus cambios. Aplicar ahora también recarga la sesión actual.",
      discard: "Descartar",
      applying: "Aplicando…",
  ...
  configView: {
    ...
    rawDisabled:
      "Modo sin procesar deshabilitado (la instantánea no puede procesar de forma segura el texto sin procesar).",
    open: "Abierto",
    clear: "Borrar",
    apply: "Aplicar",
    applying: "Aplicando…",
    ...
    viewPendingChange: "Ver {count} cambio pendiente",
