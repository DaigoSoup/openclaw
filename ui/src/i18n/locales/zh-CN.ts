...
export const zh_CN: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      accessTitle: "移动访问",
      fullAccess: "完全访问（推荐）",
      fullAccessHint: "节点以及完整的 Gateway 控制，包括设置和升级。",
      limitedAccess: "受限访问",
      limitedAccessHint: "节点、聊天和审批，不含管理控制。",
      generateCode: "创建设置代码",
      transportLimitedTitle: "为网络安全而受限",
      transportLimitedHint:
        "此 Gateway URL 使用明文 ws://。请使用 wss:// 或 Tailscale Serve，然后创建新代码以获得完全访问。",
      failed: "无法创建设置码。",
