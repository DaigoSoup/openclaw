...
export const nl: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccessHint: "Node plus complete Gateway-besturing, inclusief instellingen en upgrades.",
      limitedAccess: "Beperkte toegang",
      limitedAccessHint: "Node, chat en goedkeuringen zonder administratieve besturing.",
      generateCode: "Installatiecode maken",
      transportLimitedTitle: "Beperkt voor netwerkveiligheid",
      transportLimitedHint:
        "Deze Gateway-URL gebruikt platte tekst ws://. Gebruik wss:// of Tailscale Serve en maak dan een nieuwe code voor volledige toegang.",
