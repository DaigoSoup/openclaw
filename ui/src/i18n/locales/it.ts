...
export const it: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      accessTitle: "Accesso mobile",
      fullAccess: "Accesso completo (consigliato)",
      fullAccessHint:
        "Nodo più controlli completi del Gateway, inclusi impostazioni e aggiornamenti.",
      ...
      transportLimitedTitle: "Limitato per la sicurezza di rete",
      transportLimitedHint:
        "Questo URL del Gateway usa ws:// in chiaro. Usa wss:// o Tailscale Serve, quindi crea un nuovo codice per l'accesso completo.",
  ...
  quickSettings: {
    ...
    pending: {
      ...
      hint: "Salva memorizza le modifiche. Applica ora ricarica anche la sessione corrente.",
      discard: "Annulla",
  ...
  configView: {
    ...
    unsavedChange: "{count} modifica non salvata",
    unsavedChanges: "{count} modifiche non salvate",
    noChanges: "Nessuna modifica",
    rawDisabled:
      "Modalità raw disabilitata (lo snapshot non può gestire in sicurezza il testo raw).",
    open: "Apri",
    clear: "Cancella",
    apply: "Applica",
    applying: "Applicazione…",
    ...
    viewPendingChange: "Visualizza {count} modifica in sospeso",
    viewPendingChanges: "Visualizza {count} modifiche in sospeso",
