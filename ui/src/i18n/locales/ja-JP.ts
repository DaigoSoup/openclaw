...
export const ja_JP: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccessHint: "ノードに加え、設定やアップグレードを含む完全な Gateway コントロール。",
      limitedAccess: "制限付きアクセス",
      limitedAccessHint: "管理コントロールなしで、ノード、チャット、承認を利用できます。",
      generateCode: "セットアップコードを作成",
      transportLimitedTitle: "ネットワーク安全性のため制限中",
      transportLimitedHint:
        "この Gateway URL は平文の ws:// を使用しています。wss:// または Tailscale Serve を使用し、フルアクセス用の新しいコードを作成してください。",
  ...
  quickSettings: {
    ...
    pending: {
      title: "未保存の変更",
      hint: "保存すると変更が記録されます。今すぐ適用すると現在のセッションも再読み込みされます。",
      discard: "破棄",
      applying: "適用中…",
      applyNow: "今すぐ適用",
    },
  ...
  configView: {
    ...
    unsavedChange: "{count} 件の未保存の変更",
    unsavedChanges: "{count} 件の未保存の変更",
    noChanges: "変更なし",
    rawDisabled:
      "Raw モードは無効です（スナップショットは Raw テキストを安全にラウンドトリップできません）。",
    open: "開く",
    clear: "クリア",
    apply: "適用",
    applying: "適用中…",
    ...
    viewPendingChange: "保留中の変更 {count} 件を表示",
    viewPendingChanges: "保留中の変更 {count} 件を表示",
