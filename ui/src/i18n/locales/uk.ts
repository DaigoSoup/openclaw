...
export const uk: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccessHint:
        "Вузол разом із повним керуванням Gateway, включно з налаштуваннями та оновленнями.",
      ...
      transportLimitedTitle: "Обмежено для безпеки мережі",
      transportLimitedHint:
        "Цей URL Gateway використовує незашифрований ws://. Використайте wss:// або Tailscale Serve, а потім створіть новий код для повного доступу.",
