...
export const id: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      fullAccess: "Akses penuh (direkomendasikan)",
      fullAccessHint: "Node plus kontrol Gateway lengkap, termasuk pengaturan dan peningkatan.",
      limitedAccess: "Akses terbatas",
      limitedAccessHint: "Node, obrolan, dan persetujuan tanpa kontrol administratif.",
      generateCode: "Buat kode penyiapan",
      transportLimitedTitle: "Terbatas untuk keamanan jaringan",
      transportLimitedHint:
        "URL Gateway ini menggunakan ws:// teks biasa. Gunakan wss:// atau Tailscale Serve, lalu buat kode baru untuk akses penuh.",
