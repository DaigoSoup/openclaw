...
export const zh_TW: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      accessTitle: "行動裝置存取",
      fullAccess: "完整存取（建議）",
      fullAccessHint: "節點以及完整的 Gateway 控制項，包括設定與升級。",
      limitedAccess: "有限存取",
      limitedAccessHint: "節點、聊天與核准功能，但不含管理控制項。",
      generateCode: "建立設定碼",
      transportLimitedTitle: "為網路安全而受限",
      transportLimitedHint:
        "此 Gateway URL 使用純文字 ws://。請改用 wss:// 或 Tailscale Serve，然後建立新的設定碼以取得完整存取。",
      failed: "無法建立設定代碼。",
  ...
  quickSettings: {
    ...
    pending: {
      title: "未儲存的變更",
      hint: "儲存會保留您的變更。立即套用還會重新載入目前的工作階段。",
      discard: "捨棄",
      applying: "套用中…",
      applyNow: "立即套用",
    },
  ...
  configView: {
    ...
    unsavedChange: "{count} 項未儲存的變更",
    unsavedChanges: "{count} 項未儲存的變更",
    noChanges: "沒有變更",
    rawDisabled: "原始模式已停用（快照無法安全地往返原始文字）。",
    open: "開啟",
    clear: "清除",
    apply: "套用",
    applying: "套用中…",
    ...
    dismissWarning: "不再提醒",
    viewPendingChange: "檢視 {count} 項待處理變更",
